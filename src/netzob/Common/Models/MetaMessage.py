...
#+---------------------------------------------------------------------------+
#| MetaMessage:
#|     Definition of a meta message
#+---------------------------------------------------------------------------+
class MetaMessage(AbstractMessage):
    def __init__(self, id, timestamp, data, attributes, pattern=[]):
        AbstractMessage.__init__(self, id, timestamp, data, "Meta", pattern)

        #TODO rebuild ? and check ?
        self.attributes = attributes

        # create logger with the given configuration
        self.log = logging.getLogger('netzob.Common.Models.MetaMessage.py')
    ...
    def getProperties(self):
        ...
        for a in self.attributes:
            properties.append(Property(a[0], a[1], str(a[2])))

        properties.extend(super(MetaMessage, self).getProperties())
